                      ...
                      <table className="w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                          {(() => {
                            ...
                            // BranchRankNfile: show questions 1-5 (including Job Targets row)
                            const qualityOfWorksItems = allQualityOfWorks
                              .filter((item: { question_number: number }) => {
                                return item.question_number <= 5;
                              });

                            // BranchRankNfile doesn't have the 7 detailed job targets (that's for Branch Manager)
                        ...
                        <div className="overflow-x-auto">
                          <table className="w-full border-collapse border-2 border-gray-400 print-overall-assessment-table">
                            ...
                            <tbody>
                              ...
                              {/* Managerial Skills - NOT for BranchRankNfile (removed since it's never used) */}
