...
export default function ViewResultsModal({
  ...
  const isEvaluatorBranchManagerOrSupervisor = () => {
    if (!submission?.evaluator?.positions) return false;
  ...
  // Check if employee (being evaluated) is Branch Manager or Branch Supervisor
                        ...
                        <tbody>
                          {(() => {
                            ...
                            if (shouldShowDetailedJobTargets) {
                              ...
                              // Note: Question 12 might not exist in the array, so we'll handle that below
